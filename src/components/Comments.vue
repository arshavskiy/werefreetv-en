        ...
        <div>
            <div id="comments_holder">
                <div id="comments_section">
                    <span id="comments_section_line" v-for="comment in comments" :key="comment.date">
    ...
    export default {
        ...
        methods: {
            ...
            sendMessage() {
                ...
                if (!this.userName) {
                    this.userName = 'שדה חובה...';
                }
                if (!this.userComment) {
                    this.userComment = 'שדה חובה...';
                }
                ...
                if (this.userComment && this.userName) {
                    ...
                    fetch('https://data.wearefree.tv/post' + data,{
                        ...
                        this.comments = this.comments.concat(json.body);
